...
```bash
git clone https://github.com/jewfu123/phaser3-parcel-game.git
```

This will create a folder named `phaser3-parcel-game`. You can specify a different folder name like this:

```bash
git clone https://github.com/jewfu123/phaser3-parcel-game.git my-folder-name
```

Go into your new project folder and install dependencies:

```bash
cd phaser3-parcel-game # or 'my-folder-name'
npm install
```
